...
def main():
 ...
 for cid in ids:
  native(DATA/f'images/{cid}_0000.nii.gz',P/f'artifacts/ta36_ct_output/{cid}.nii.gz',P/f'artifacts/ct_fold2_all109_boxes/{cid}_boxes.pkl',C,RUN/'model/final_last.pt',F11/'model/final_last.pt',threshold['parent_image_threshold'],R13/'model/final.joblib',threshold['threshold'],RUN/f'predictions_ct/{cid}.nii.gz','cuda:0');print('CT_E21',cid,flush=True)
