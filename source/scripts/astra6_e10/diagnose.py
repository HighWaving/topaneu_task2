import json
import numpy as np
from scripts.astra6_e10.prepare import RUN,SHAPE
...
ids=json.loads((SHAPE.parent/'astra6_e02_multiscale_vessel_signature_20260908T173916Z/eval_case_ids.json').read_text());results={}
for cid in ids:
...
write_json(RUN/'evaluation/lesion_diagnostics.json',{'E10':summary,'E04':json.loads((SHAPE/'evaluation/extended_diagnostics.json').read_text())['versions']['E04'],'binary_foreground_identical_all40':True,'cases':results});print(json.dumps(summary,indent=2))
