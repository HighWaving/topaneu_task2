...
P=Path(__file__).resolve().parents[2];RUN=P/'artifacts/astra6_e23_MR_oof_candidates_20260909';TASK='Task130FG_TopAneuMR_OOF';MODEL='RetinaUNetV001_D3V001_3d'
def sha(p):
 h=hashlib.sha256()
...
def active(fold,run):
 ...
 expected=str(P/'scripts/astra6_e23/training_entry.py').encode()
