...
from scripts.astra6_e26.prepare import RUN,P,DATA
...
def main():
 ...
 for n,cid in enumerate(ids,1):
  ...
  for idx,score,low,high in reversed(select_candidates(bx,sc)):
   ...
   out.append(new)
  nifti_output(mask,DATA/f'images/{cid}_0000.nii.gz',RUN/f'predictions/mr_center2_k05/{cid}.nii.gz');print('E26',n,40,cid,flush=True)
