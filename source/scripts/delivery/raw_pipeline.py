...
def main():
 ...
 env=os.environ.copy();env.update(CUDA_VISIBLE_DEVICES=a.gpu,OMP_NUM_THREADS='4',PYTHONUNBUFFERED='1');raw=a.work/'case_0000.nii.gz';sitk.WriteImage(sitk.ReadImage(str(a.image)),str(raw),True)
