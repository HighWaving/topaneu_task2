import json
import numpy as np
from scripts.astra6_e05.run_e05 import RUN,SHAPE
...
write_json(RUN/'evaluation/lesion_diagnostics.json',{'E05':summary,'E04':json.loads((SHAPE/'evaluation/extended_diagnostics.json').read_text())['versions']['E04'],'binary_foreground_identical_all40':True,'cases':results});print(json.dumps(summary,indent=2))
