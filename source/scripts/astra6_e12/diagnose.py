import json
import numpy as np
from scripts.astra6_e12.common import RUN
...
write_json(RUN/'evaluation/lesion_diagnostics.json',{'E12':summary,'E04':old['versions']['E04'],'selected':len(candidate_rows),'kept':sum(r['filter_keep'] for r in candidate_rows),'cases':results});print(json.dumps(summary,indent=2),flush=True)
